 ...
 */
@Component
public class CusServerAuthenticationEntryPoint implements ServerAuthenticationEntryPoint {

    private static String WWW_AUTHENTICATE_FORMAT = "Basic realm=\"%s\"";
    private String headerValue = createHeaderValue("Realm");

    public CusServerAuthenticationEntryPoint() {
    }
    ...
    public Mono<Void> commence(ServerWebExchange exchange, AuthenticationException e) {
        ...
        byte[] dataBytes = "身份鉴权失败".toString().getBytes();
