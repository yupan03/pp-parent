...
-- ----------------------------
-- Records of organizational_structure
-- ----------------------------
...
CREATE TABLE `pdman_db_version` (
  `DB_VERSION` varchar(256) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `VERSION_DESC` varchar(1024) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `CREATED_TIME` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL
...
) ENGINE=InnoDB AUTO_INCREMENT=1745 DEFAULT CHARSET=utf8mb4  COMMENT='资源表';
...
CREATE TABLE `user` (
  `id` varchar(50) NOT NULL,
  `account` varchar(45) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT '账号',
  `name` varchar(45) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT '名称',
  `password` varchar(45) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT '密码',
  `email` varchar(45) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT '邮箱',
  `enable` tinyint(1) DEFAULT '1' COMMENT '状态: 0 停用  1 正常',
  `type` tinyint(4) DEFAULT '0',
  `create_time` varchar(32) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`),
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'yupan', '吁盼', '123456', '735997736@qq.com', '0', '0', null);
