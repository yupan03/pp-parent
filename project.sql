...
CREATE TABLE `file_record` (
  ...
  `attachment_name` varchar(50) DEFAULT NULL COMMENT '附件uuid',
  `attachment_path` varchar(500) DEFAULT NULL COMMENT '附件路径',
  `type` tinyint(4) DEFAULT NULL COMMENT '类型：0.excel下载  1.文件上传',
  `opr_id` bigint(20) DEFAULT NULL COMMENT '操作人',
...
-- ----------------------------
BEGIN;
INSERT INTO `file_record` VALUES (1326571255637213184, 'timg (1).jpg', '7dd06b39-3a48-4edb-bdbb-838e4e8cdbb5', 'C:\\file_service\\pp\\temp', 1, 123, '2020-01-09 07:20:34', '2020-01-09 07:20:34');
INSERT INTO `file_record` VALUES (1326910361021972480, '2.jpg', 'c2961b72-1a8e-4a53-92e4-25f9cbb25ede', 'C:\\file_service\\pp\\temp', 1, 123, '2020-01-10 05:48:03', '2020-01-10 05:48:03');
COMMIT;

-- ----------------------------
-- Table structure for filter_api
-- ----------------------------
DROP TABLE IF EXISTS `filter_api`;
CREATE TABLE `filter_api` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='网关不需要token验证的api';

-- ----------------------------
-- Records of filter_api
-- ----------------------------
BEGIN;
INSERT INTO `filter_api` VALUES (1, '/login', 0, '', '2019-09-25 14:34:23');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `gateway_route_definition` VALUES (51, 'pp-web', '/web/**', 'lb://pp-web', 1, '2019-07-22 17:41:09');
INSERT INTO `gateway_route_definition` VALUES (52, '', '', '', 0, '2019-07-27 12:28:22');
INSERT INTO `gateway_route_definition` VALUES (53, '', '', '', 0, '2019-08-01 13:48:07');
INSERT INTO `gateway_route_definition` VALUES (54, '12341234', '', '', 0, '2019-08-02 09:36:16');
COMMIT;

-- ----------------------------
-- Table structure for organizational_structure
-- ----------------------------
...
-- ----------------------------
-- Table structure for outside_app
-- ----------------------------
DROP TABLE IF EXISTS `outside_app`;
...
CREATE TABLE `resource` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `parent_url` varchar(100) DEFAULT NULL,
  `resource_name` varchar(100) DEFAULT NULL,
  `resource_url` varchar(100) DEFAULT NULL,
  `resource_method` varchar(100) DEFAULT NULL,
  `resource_param` varchar(100) DEFAULT NULL,
  `remark` varchar(100) DEFAULT NULL,
  `create_time` varchar(20) DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `resource_UN` (`parent_url`,`resource_url`)
...
-- ----------------------------
BEGIN;
INSERT INTO `resource` VALUES (1, '/', '用户管理管理', '/user', NULL, NULL, '', '2019-03-08 09:08:25');
INSERT INTO `resource` VALUES (2, '/user', '获取用户基本信息', '/user/getUserInfo', 'GET,POST', 'param(java.lang.String),list(java.util.List),data([Ljava.lang.String;)', '', '2019-03-08 09:08:25');
INSERT INTO `resource` VALUES (3, '/', '角色管理', '/role', NULL, NULL, '', '2019-03-27 10:55:48');
INSERT INTO `resource` VALUES (4, '/role', '新增', '/role/add', 'POST', 'role(com.project.entity.tables.role.Role)', '', '2019-03-27 10:55:48');
INSERT INTO `resource` VALUES (5, '/role', '修改', '/role/update', 'POST', 'role(com.project.entity.tables.role.Role)', '', '2019-03-27 10:55:48');
INSERT INTO `resource` VALUES (6, '/role', '删除', '/role/delete', 'POST', 'id(java.lang.String)', '', '2019-03-27 10:55:48');
INSERT INTO `resource` VALUES (107, '/', '资源管理管理', '/resource', NULL, NULL, '', '2019-03-29 16:50:26');
INSERT INTO `resource` VALUES (108, '/resource', '列表', '/resource/pageList', 'POST', '', '', '2019-03-29 16:50:26');
INSERT INTO `resource` VALUES (109, '/role', '列表', '/role/pageList', 'POST', '', '', '2019-03-29 16:50:26');
INSERT INTO `resource` VALUES (110, '/role', '角色资源列表', '/role/roleResourceList', 'POST', 'roleId(java.lang.String)', '', '2019-03-29 16:50:26');
INSERT INTO `resource` VALUES (111, '/role', '编辑角色资源', '/role/updateRoleResource', 'POST', 'roleResources(java.util.List)', '', '2019-03-29 16:50:26');
INSERT INTO `resource` VALUES (112, '/user', '新增', '/user/add', 'POST', 'user(com.project.entity.tables.user.User)', '', '2019-03-29 16:50:26');
INSERT INTO `resource` VALUES (113, '/user', '更新', '/user/update', 'POST', 'user(com.project.entity.tables.user.User)', '', '2019-03-29 16:50:26');
INSERT INTO `resource` VALUES (114, '/user', '删除', '/user/delete', 'POST', 'user(com.project.entity.tables.user.User)', '', '2019-03-29 16:50:26');
INSERT INTO `resource` VALUES (115, '/user', '列表', '/user/pageList', 'POST', 'user(com.project.entity.tables.user.User)', '', '2019-03-29 16:50:26');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `role` VALUES ('085d8308-505a-11e9-b366-00163e124e01', '系统管理员', '2019-03-27 14:32:03');
INSERT INTO `role` VALUES ('0bb4ef84-505a-11e9-b366-00163e124e01', '系统管理员', '2019-03-27 14:32:08');
INSERT INTO `role` VALUES ('40190b81-5040-11e9-b366-00163e124e01', '系统管理员', '2019-03-27 11:27:30');
INSERT INTO `role` VALUES ('5653de8b-5041-11e9-b366-00163e124e01', '系统管理员', '2019-03-27 11:35:16');
COMMIT;
...
CREATE TABLE `role_resource` (
  ...
  `parent_url` varchar(100) DEFAULT NULL,
  `parent_name` varchar(100) DEFAULT NULL COMMENT '父路径名称',
  `resource_url` varchar(100) DEFAULT NULL,
  `resource_name` varchar(100) DEFAULT NULL,
...
CREATE TABLE `user` (
  ...
  `state` int(1) DEFAULT '1' COMMENT '状态: 0 停用  1 正常',
  `type` int(4) DEFAULT '0',
  `create_time` varchar(32) DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_UN` (`account`) USING BTREE COMMENT '用户账号唯一不能重复'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
-- ----------------------------
BEGIN;
INSERT INTO `user` VALUES (1, 'yupan1', '吁盼', '123456', '735997736@qq.com', 1, 0, '2019-12-12 12:12:12');
INSERT INTO `user` VALUES (2, 'yupan3', '吁盼', NULL, NULL, 0, NULL, NULL);
INSERT INTO `user` VALUES (3, 'yupan2', '吁盼', NULL, NULL, 0, NULL, NULL);
INSERT INTO `user` VALUES (4, 'yupan4', '吁盼', NULL, NULL, 0, NULL, NULL);
INSERT INTO `user` VALUES (1324309779081854976, 'yupan5', '吁盼', NULL, NULL, 0, NULL, NULL);
INSERT INTO `user` VALUES (1324310190928953344, 'yupan6', '吁盼', NULL, NULL, 0, NULL, NULL);
INSERT INTO `user` VALUES (1324310688406962176, 'yupan7', '吁盼', NULL, NULL, 0, NULL, NULL);
INSERT INTO `user` VALUES (1324337288527740928, 'yupan8', '吁盼', NULL, NULL, 0, NULL, NULL);
COMMIT;
